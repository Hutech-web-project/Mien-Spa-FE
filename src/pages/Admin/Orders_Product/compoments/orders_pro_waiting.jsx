...
const OrdersProWaiting = (props) => {
    ...
    useEffect(() => {
        dispatch(getOrderProduct()).then((res) => {
            setDataListOrderProduct(res.payload?.filter((ord) => ord.orProStatus !== "Delivered" && ord.orProStatus !== "Cancelled"));
            setDataListSearch(res.payload?.filter((ord) => ord.orProStatus !== "Delivered" && ord.orProStatus !== "Cancelled"));
        });
    }, [dispatch]);
                                ...
                                return (
                                    <tr>
                                        ...
                                        <td className='d-flex justify-content-center'>
                                            <Button className='btn-action' variant="success" >Manage</Button>
                                            {/* <EditOrder
                                                show={editShow}
