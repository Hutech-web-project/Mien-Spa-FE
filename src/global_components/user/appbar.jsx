          ...
          <Container>
            ...
            <Navbar.Collapse id="responsive-navbar-nav" className='nav-collapse' >
              <Nav className="me-auto nav-collapse-item">
                ...
                <Nav.Link className={activePage === 7 ? 'active' : ''} href="/users" ><FontAwesomeIcon icon={['fa', 'users']} /> users</Nav.Link>
              </Nav >
              <Nav className='nav-collapse-item'>
              {activePage === 2 ?
              <Nav.Link className={activePage === 4 ? 'active' : ''} href="/shopping-cart"><FontAwesomeIcon icon={['fas', 'cart-shopping']} /> Cart</Nav.Link>
              :
